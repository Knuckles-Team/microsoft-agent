...
5. **Domain-Specific Checks**:
   - **Emails**: Fetch all unread emails. Ensure emails marked as high importance are prioritized and placed at the top of the list.
   - **Calendar**: Summarize upcoming meetings for the next 24 hours.
