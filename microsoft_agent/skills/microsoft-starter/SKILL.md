---
name: microsoft-starter
description: >-
  Microsoft API + MCP Server + A2A Server Use when working with Microsoft via this package's MCP
...
license: MIT
tags: [microsoft-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Microsoft Starter Skill

Starter skill for the **Microsoft** package. Use the `mcp-client` universal skill
