[ Skip to main content ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
...
Version Microsoft Graph REST API v1.0
  * [1.0](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
  * [beta](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-beta)
...
Suggestions will filter as you type
  ...
  *     * [Overview](https://learn.microsoft.com/en-us/graph/api/overview?view=graph-rest-1.0&preserve-view=true)
    *       * [Overview](https://learn.microsoft.com/en-us/graph/api/resources/excel?view=graph-rest-1.0)
      *         * [Chart](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
        * [List](https://learn.microsoft.com/en-us/graph/api/chart-list?view=graph-rest-1.0)
        * [Get](https://learn.microsoft.com/en-us/graph/api/chart-get?view=graph-rest-1.0)
        * [Update](https://learn.microsoft.com/en-us/graph/api/chart-update?view=graph-rest-1.0)
        * [Delete](https://learn.microsoft.com/en-us/graph/api/chart-delete?view=graph-rest-1.0)
        * [List chart series](https://learn.microsoft.com/en-us/graph/api/chart-list-series?view=graph-rest-1.0)
        * [Create chart series](https://learn.microsoft.com/en-us/graph/api/chart-post-series?view=graph-rest-1.0)
        * [Add chart](https://learn.microsoft.com/en-us/graph/api/chartcollection-add?view=graph-rest-1.0)
        * [Get chart at](https://learn.microsoft.com/en-us/graph/api/chartcollection-itemat?view=graph-rest-1.0)
        * [Get chart image](https://learn.microsoft.com/en-us/graph/api/chart-image?view=graph-rest-1.0)
        * [Reset data](https://learn.microsoft.com/en-us/graph/api/chart-setdata?view=graph-rest-1.0)
        * [Set position data](https://learn.microsoft.com/en-us/graph/api/chart-setposition?view=graph-rest-1.0)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0) Add to Collections Add to plan [ Edit ](https://github.com/microsoftgraph/microsoft-graph-docs-contrib/blob/main/api-reference/v1.0/resources/workbookchart.md)
* * *
#### Share via
[ Facebook ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fresources%2Fworkbookchart%3Fview%3Dgraph-rest-1.0%26WT.mc_id%3Dfacebook) [ x.com ](https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fresources%2Fworkbookchart%3Fview%3Dgraph-rest-1.0%26WT.mc_id%3Dtwitter&tw_p=tweetbutton&url=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fresources%2Fworkbookchart%3Fview%3Dgraph-rest-1.0%26WT.mc_id%3Dtwitter) [ LinkedIn ](https://www.linkedin.com/feed/?shareActive=true&text=%0A%0D%0Ahttps%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fresources%2Fworkbookchart%3Fview%3Dgraph-rest-1.0%26WT.mc_id%3Dlinkedin) Email
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0) or changing directories.
Access to this page requires authorization. You can try changing directories.
# workbookChart resource type
Feedback
Summarize this article for me
##  In this article
  1. [Methods](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#methods)
  2. [Properties](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#properties)
  3. [Relationships](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#relationships)
  4. [JSON representation](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#json-representation)


Namespace: microsoft.graph
Represents a chart object in a workbook.
[](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#methods)
## Methods
Expand table
...
[](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#properties)
## Properties
Expand table
...
[](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#relationships)
## Relationships
Expand table
...
[](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0#json-representation)
## JSON representation
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/api/resources/workbookchart?view=graph-rest-1.0)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fresources%2Fworkbookchart%3Fview%3Dgraph-rest-1.0)
