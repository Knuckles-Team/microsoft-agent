[ Skip to main content ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0)
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0) Add to Collections Add to plan [ Edit ](https://github.com/microsoftgraph/microsoft-graph-docs-contrib/blob/main/concepts/overview.md)
* * *
#### Share via
[ Facebook ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Foverview%3Fcontext%3Dgraph%252Fapi%252F1.0%26view%3Dgraph-rest-1.0%26WT.mc_id%3Dfacebook) [ x.com ](https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Foverview%3Fcontext%3Dgraph%252Fapi%252F1.0%26view%3Dgraph-rest-1.0%26WT.mc_id%3Dtwitter&tw_p=tweetbutton&url=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Foverview%3Fcontext%3Dgraph%252Fapi%252F1.0%26view%3Dgraph-rest-1.0%26WT.mc_id%3Dtwitter) [ LinkedIn ](https://www.linkedin.com/feed/?shareActive=true&text=%0A%0D%0Ahttps%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Foverview%3Fcontext%3Dgraph%252Fapi%252F1.0%26view%3Dgraph-rest-1.0%26WT.mc_id%3Dlinkedin) Email
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0) or changing directories.
Access to this page requires authorization. You can try changing directories.
# Overview of Microsoft Graph
Feedback
Summarize this article for me
##  In this article
  1. [Data and services powering the Microsoft 365 platform](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#data-and-services-powering-the-microsoft-365-platform)
  2. [What's in Microsoft Graph?](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#whats-in-microsoft-graph)
  3. [What can you do with Microsoft Graph?](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#what-can-you-do-with-microsoft-graph)
  4. [Bring data from an external content source to Microsoft Graph](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#bring-data-from-an-external-content-source-to-microsoft-graph)
  5. [Access Microsoft Graph data at scale](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#access-microsoft-graph-data-at-scale)
  6. [When should I use Microsoft Graph API or Data Connect?](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#when-should-i-use-microsoft-graph-api-or-data-connect)
  7. [Try out a sample app](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#try-out-a-sample-app)
  8. [Related content](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#related-content)
...
![Microsoft Graph, Microsoft Graph Data Connect, and Copilot connectors enable extending Microsoft 365 experiences and building intelligent apps.](https://learn.microsoft.com/en-us/graph/images/microsoft-graph-dataconnect-connectors-enhance.png)
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#data-and-services-powering-the-microsoft-365-platform)
...
In the Microsoft 365 platform, three main components facilitate the access and flow of data:
  ...
  * **[Microsoft 365 Copilot connectors](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#bring-data-from-an-external-content-source-to-microsoft-graph)** (formerly Microsoft Graph connectors) work in the incoming direction, delivering data external to the Microsoft cloud into Microsoft Graph services and applications to enhance Microsoft 365 experiences such as Microsoft Search. Connectors exist for many commonly used data sources such as Box, Google Drive, Jira, and Salesforce.
  * **[Microsoft Graph Data Connect](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#access-microsoft-graph-data-at-scale)** provides a set of tools to streamline secure and scalable delivery of Microsoft Graph data to popular Azure data stores. The cached data serves as data sources for Azure development tools that you can use to build intelligent applications.
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#whats-in-microsoft-graph)
...
![An image showing the primary resources and relationships that are part of Microsoft Graph](https://learn.microsoft.com/en-us/graph/images/microsoft-graph.png)
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#what-can-you-do-with-microsoft-graph)
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#popular-api-requests)
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#bring-data-from-an-external-content-source-to-microsoft-graph)
## Bring data from an external content source to Microsoft Graph
Use [Copilot connectors](https://learn.microsoft.com/en-us/graph/connecting-external-content-connectors-overview) to bring data that is external to the Microsoft cloud into Microsoft Graph. Examples of such data can be an organization's human resources database or product catalog, hosted on-premises or in the public or private clouds.
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#access-microsoft-graph-data-at-scale)
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#when-should-i-use-microsoft-graph-api-or-data-connect)
...
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#try-out-a-sample-app)
## Try out a sample app
Use the [quick start](https://developer.microsoft.com/graph/quick-start) to set up a ready-to-run sample app.
[](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0#related-content)
## Related content
...
Try Microsoft Graph APIs on the default sample tenant to explore capabilities, or sign in to your tenant and use it as a prototyping tool to fulfill your app scenarios.
  * [ Major services and features in Microsoft Graph - Microsoft Graph ](https://learn.microsoft.com/en-us/graph/overview-major-services?source=recommendations)
Learn how Microsoft Graph's network of services and features manage, protect, and extract data to support a wide range of scenarios.
...
In addition to using the Microsoft Graph API to read and write data, you can use a number of request patterns to traverse through the resources in Microsoft Graph. The metadata document also helps you to understand the data model of the resources and relationships in Microsoft Graph.
  * [ Users you can reach with Microsoft Graph - Microsoft Graph ](https://learn.microsoft.com/en-us/graph/users-you-can-reach?source=recommendations)
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/overview?context=graph%2Fapi%2F1.0&view=graph-rest-1.0)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Foverview%3Fcontext%3Dgraph%252Fapi%252F1.0%26view%3Dgraph-rest-1.0)
