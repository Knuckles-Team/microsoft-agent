[ Skip to main content ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#main) [ Skip to Ask Learn chat experience ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http)
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http)
  * [ Profile ](https://learn.microsoft.com/en-us/users/me/activity/)
  * [ Settings ](https://learn.microsoft.com/en-us/users/me/settings/)


[ Sign out ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http)
...
Version Microsoft Graph REST API v1.0
  * [1.0](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0)
  * [beta](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-beta)
...
Suggestions will filter as you type
  ...
  *     * [Overview](https://learn.microsoft.com/en-us/graph/api/overview?view=graph-rest-1.0&preserve-view=true)
    *       * [Overview](https://learn.microsoft.com/en-us/graph/api/resources/calendar-overview?view=graph-rest-1.0)
      *         * [Event](https://learn.microsoft.com/en-us/graph/api/resources/event?view=graph-rest-1.0)
        * [List](https://learn.microsoft.com/en-us/graph/api/user-list-events?view=graph-rest-1.0)
        * [Create](https://learn.microsoft.com/en-us/graph/api/user-post-events?view=graph-rest-1.0)
        * [Get](https://learn.microsoft.com/en-us/graph/api/event-get?view=graph-rest-1.0)
        * [Update](https://learn.microsoft.com/en-us/graph/api/event-update?view=graph-rest-1.0)
        * [Delete](https://learn.microsoft.com/en-us/graph/api/event-delete?view=graph-rest-1.0)
        * [Permanently delete](https://learn.microsoft.com/en-us/graph/api/event-permanentdelete?view=graph-rest-1.0)
        * [Get delta](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0)
        ...
        * [Accept event](https://learn.microsoft.com/en-us/graph/api/event-accept?view=graph-rest-1.0)
        * [Tentatively accept](https://learn.microsoft.com/en-us/graph/api/event-tentativelyaccept?view=graph-rest-1.0)
        * [Decline event](https://learn.microsoft.com/en-us/graph/api/event-decline?view=graph-rest-1.0)
        * [Dismiss reminder](https://learn.microsoft.com/en-us/graph/api/event-dismissreminder?view=graph-rest-1.0)
        * [Snooze reminder](https://learn.microsoft.com/en-us/graph/api/event-snoozereminder?view=graph-rest-1.0)
        * [List event instances](https://learn.microsoft.com/en-us/graph/api/event-list-instances?view=graph-rest-1.0)
...
Table of contents [ Read in English ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http) Add to Collections Add to plan [ Edit ](https://github.com/microsoftgraph/microsoft-graph-docs-contrib/blob/main/api-reference/v1.0/api/event-delta.md)
* * *
#### Share via
[ Facebook ](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fevent-delta%3Fview%3Dgraph-rest-1.0%26tabs%3Dhttp%26WT.mc_id%3Dfacebook) [ x.com ](https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fevent-delta%3Fview%3Dgraph-rest-1.0%26tabs%3Dhttp%26WT.mc_id%3Dtwitter&tw_p=tweetbutton&url=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fevent-delta%3Fview%3Dgraph-rest-1.0%26tabs%3Dhttp%26WT.mc_id%3Dtwitter) [ LinkedIn ](https://www.linkedin.com/feed/?shareActive=true&text=%0A%0D%0Ahttps%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fevent-delta%3Fview%3Dgraph-rest-1.0%26tabs%3Dhttp%26WT.mc_id%3Dlinkedin) Email
* * *
Copy Markdown Print
* * *
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http) or changing directories.
Access to this page requires authorization. You can try changing directories.
# event: delta
Feedback
Summarize this article for me
##  In this article
  1. [Permissions](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#permissions)
  2. [HTTP request](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#http-request)
  3. [Query parameters](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#query-parameters)
  4. [Request headers](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#request-headers)
  5. [Response](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#response)
  6. [Example](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#example)
  7. [Related content](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#related-content)
...
---|---|---|---
✅ | ✅ | ✅ | ✅
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#permissions)
## Permissions
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#http-request)
## HTTP request
HTTP
Copy
```
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#query-parameters)
## Query parameters
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#odata-query-parameters)
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#request-headers)
## Request headers
Expand table
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#response)
## Response
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#example)
## Example
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#request)
##### Request
...
To track changes in a calendar view, you would make one or more **delta** function calls, with appropriate [state tokens](https://learn.microsoft.com/en-us/graph/delta-query-overview), to get the set of incremental changes since the last delta query.
  * [HTTP](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_http)
  * [C#](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_csharp)
  * [Go](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_go)
  * [Java](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_java)
  * [JavaScript](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_javascript)
  * [PHP](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_php)
  * [Python](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#tabpanel_1_python)
...
> For details about how to [add the SDK](https://learn.microsoft.com/en-us/graph/sdks/sdk-installation) to your project and [create an authProvider](https://learn.microsoft.com/en-us/graph/sdks/choose-authentication-providers) instance, see the [SDK documentation](https://learn.microsoft.com/en-us/graph/sdks/sdks-overview).
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#response-1)
##### Response
...
[](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http#related-content)
## Related content
...
[ Sign in ](https://learn.microsoft.com/en-us/graph/api/event-delta?view=graph-rest-1.0&tabs=http)
[English (United States)](https://learn.microsoft.com/en-us/locale?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fgraph%2Fapi%2Fevent-delta%3Fview%3Dgraph-rest-1.0)
